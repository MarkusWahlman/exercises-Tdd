...
`}rotateRight(){const t=(this.rotationIndex+1)%this.constructor.rotationStates.length;return new this.constructor(t)}rotateLeft(){const t=(this.rotationIndex+this.constructor.rotationStates.length-1)%this.constructor.rotationStates.length;return new this.constructor(t)}}const u=class u extends c{constructor(t=0){super(c.fromString(u.rotationStates[t]).grid,t)}};n(u,"rotationStates",[`.....
     ...
     ...I.
     ...I.
     .....`]);let L=u;const g=class g extends c{constructor(t=0){super(c.fromString(g.rotationStates[t]).grid,t)}};n(g,"rotationStates",[`...
     TTT
     .T.`,`.T.
     TT.
     .T.`,`...
     ...
     TTT`,`.T.
     .TT
     .T.`]);let b=g;const d=class d extends c{constructor(t=0){super(c.fromString(d.rotationStates[t]).grid,t)}};n(d,"rotationStates",[`...
     LLL
     L..`,`LL.
     .L.
     .L.`,`...
     ...
     LLL`,`.L.
     .L.
     .LL`]);let v=d;const m=class m extends c{constructor(t=0){super(c.fromString(m.rotationStates[t]).grid,t)}};n(m,"rotationStates",[`...
     JJJ
     ..J`,`.J.
     .J.
     JJ.`,`...
     ...
     SS.`,`S..
     SS.
     .S.`]);let A=S;const w=class w extends c{constructor(t=0){super(c.fromString(w.rotationStates[t]).grid,t)}};n(w,"rotationStates",[`...
     ZZ.
     .ZZ`,`..Z
     .ZZ
     .Z.`,`...
     ...
     .ZZ`,`.Z.
     ZZ.
     Z..`]);let y=w;class D extends c{constructor(){super(c.fromString(`...
         .OO
